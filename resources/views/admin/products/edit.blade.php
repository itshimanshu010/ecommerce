                    ...
                    <form class="forms-sample" method="post" action="{{ route('admin.products.update', $product->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <div class="form-group col-md-6">
                                ...
                                <input id="title" class="form-control" type="text" name="title" value="{{ old('title', $product->title) }}" placeholder="Product Title">
                                @if($errors->has("title"))
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="price" class="form-control" type="text" name="price" value="{{ old('price', $product->price) }}" placeholder="Product Price">
                                @if($errors->has("price"))
